...
import { Page, PageBuilder } from '../components/core/index.js'

import { useLocalizedRoute, middleware as i18nRouteMiddleware } from '../i18n/index.js'
import { useTransitionAlt } from '../composables/index.js'

import { pageTransition } from '../transitions/page.js'
