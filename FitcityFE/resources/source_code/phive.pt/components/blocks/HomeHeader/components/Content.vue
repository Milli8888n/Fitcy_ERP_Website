...
const setup = () => {}
const init = () => {
	el.value.querySelector('a').addEventListener('mouseenter', () => props.pauseFunc())
	el.value.querySelector('a').addEventListener('mouseleave', () => props.playFunc())
	openCloseAnimation()
}
const kill = () => {
	el.value.querySelector('a').removeEventListener('mouseenter', () => props.pauseFunc())
	el.value.querySelector('a').removeEventListener('mouseleave', () => props.playFunc())
}
