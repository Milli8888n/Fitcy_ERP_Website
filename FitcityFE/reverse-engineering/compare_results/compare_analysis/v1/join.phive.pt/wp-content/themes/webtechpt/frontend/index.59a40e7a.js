...
var _checkoutJsDefault = parcelHelpers.interopDefault(_checkoutJs);
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (pageType === "home") pageInstance = new (0, _homeJsDefault.default)();
    else if (pageType === "checkout") pageInstance = new (0, _checkoutJsDefault.default)();
    // Initialize the page instance if one is set
    if (pageInstance) pageInstance.init();
    // Cleanup logic
...
},{"./home.js":"cEl3V","./checkout.js":"dhtLq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cEl3V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class HomePage {
    ...
    setupEventListeners() {
        this.boundResizeHandler = ()=>this.useFullWidthFontSize({
                element: document.querySelector(".title")
            });
        window.addEventListener("resize", this.boundResizeHandler);
    }
    initAnimations() {
        this.animation = (0, _gsapDefault.default).fromTo(".subtitle", {
            opacity: 0
        }, {
            opacity: 1,
            duration: 1
    ...
    animateIn() {
        (0, _gsapDefault.default).fromTo(document.querySelectorAll(".label"), {
            x: 50,
            autoAlpha: 0
        }, {
            x: 0,
    ...
    initParallax() {
        ...
        images.forEach((image, index)=>{
            ...
            (0, _scrollTrigger.ScrollTrigger).create({
                ...
                scrub: true,
                onUpdate: (self)=>{
                    (0, _gsapDefault.default).to(image.querySelector("img"), {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dhtLq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aP7aF","8lRBv"], "8lRBv", "parcelRequire94c2")
